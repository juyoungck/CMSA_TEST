                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (deleteItem != null) {
                            ...
                            try {
                                ...
                                int rowsAffected = db.delete("Closet_Location", "c_loc_name = ?", new String[]{closetName});
                ...
                builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!newName.isEmpty()) {
                            ...
                            values.put("c_loc_name", newName);
                            db.update("Closet_Location", values, "c_loc_name = ?", new String[]{item});
